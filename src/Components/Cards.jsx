    ...
    <div className="w-full h-[80vh] flex gap-10 px-20 bg-zinc-900 justify-start items-center">
      ...
      <div className="cardcontainer w-1/2 h-[30vw] flex gap-5 justify-center items-center">
        <div className=" card relative w-1/2 flex justify-center items-center h-full bg-zinc-800 rounded-xl">
          ...
          <div className=" absolute font-primary bg-gradient-to-r from-pink-600 to-purple-600 blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt left-10 bottom-10 px-10 py-3 border-[1px] text-sm border-zinc-300 rounded-full">
            View Project
          </div>
        </div>
        <div className=" card relative w-1/2 flex justify-center items-center h-full bg-zinc-800 rounded-xl">
          <img className="w-full h-full " src={image2} alt="" />
          <button className=" absolute font-primary left-10 bottom-10 px-5 py-1 border-[1px] text-sm border-zinc-300 rounded-full">
            View Project
          </button>
        </div>
      </div>
